...
public enum BuyRange implements Budget {
    USD_14000_20000("14000 - 20000", "1"), USD_20000_25000("20000 - 25000", "2"), USD_25000_30000("25000 - 30000", "3"),
    ...
    @Override
    public Budget[] getAllRanges() {
        return BuyRange.values();
    }

    BuyRange(final String range, final String identifier) {
        this.range = range + " $";
        this.identifier = "&buy" + identifier + "buy#";
    }
